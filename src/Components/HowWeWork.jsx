        ...
        <div className="wrapper relative z-10">
          <div className="text-center mb-12">
            <h1 className="main-title" data-aos="fade-up">
              Invest in your Goals with Onfuturesites
            </h1>
          ...
          <section className="grid md:grid-cols-2 gap-10">
            ...
            <div className=" h-full flex flex-col gap-5">
              ...
              <p className="desc" data-aos="fade-right">
                At Onfuturesites, we collaborate closely with clients to
          ...
          <section className="my-16">
            ...
            <p className="desc" data-aos="fade-up">
              At Onfuturesites, our vision is to be the most advanced AI-driven
          ...
          <section>
            ...
            <p className="desc" data-aos="fade-up">
              At Onfuturesites, we believe that exceptional achievements are
              born from visionary collaborations. By merging your unique
              aspirations with our quantum-level AI expertise, we can co-create
